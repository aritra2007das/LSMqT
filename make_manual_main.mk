...
OBJS = Pi_ff_B.o Pi_ff_ThM.o PipiB.o\
		...
		pi0_disp.o mass_pi0.o manual_main.o \
...
manual_main.o: manual_main.c include/V_decl.h include/Pi0.h
	$(CC) $(CFLAG) $(WARNFLAGS) $(CCFLAGS) -c manual_main.c
